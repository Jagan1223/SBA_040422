...
public class Q3 {
	public static void main(String[] args) throws IOException {
		...
		if (f1.exists()) {
			...
			System.out.println("Hidden: " + f1.isHidden());// Returns true if the specified Path locates a file that is
															// considered hidden by the file system.
			System.out.println("lastModifiedTime: " + f1.lastModified());// Returns the specified file's last modified
																			// time.
			System.out.println("isDirectory: " + f1.isDirectory());// Returns true if the specified Path locates a file
																	// that is a directory.
		} else {
