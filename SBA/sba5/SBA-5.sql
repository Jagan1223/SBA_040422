...
mov_id int not null,gen_id int not null,
foreign key(mov_id) references movie(mov_id),
...
('James','Stewart','M'),('Deborah','Kerr','F'),('Peter','OToole','M'),
...
('Alfred','Hitchcock'),('Jack','Clayton'),('David','Lean'),('Michael','Cimino'),
('Milos','Forman'),('Ridley','Scott'),('Stanley','Kubrick'),('Bryan','Singer'),
('Roman','Polanski'),('Paul','Thomas Anderson'),('Woody','Allen'),('Hayao','Miyazaki'),
('Frank','Darabont'),('Sam','Mendes'),('James','Cameron'),('Gus','Van Sant'),
('John','Boorman'),('Danny','Boyle'),('Christopher','Nolan'),('Richard','Kelly'),
('Kevin','Spacey'),('Andrei','Tarkovsky'),('Peter','Jackson');

insert into genres(gen_title) values
...
('Boogle Nights',1997,155,'English','1998-02-16','UK'),
...
('Allens',1986,137,'English','1986-08-29','UK'),
...
(922,1001),(917,1002),(903,1002),(912,1003),
(911,1005),(908,1006),(913,1006),(926,1007),(928,1007),
(918,1007),(921,1007),(902,1008),(923,1009),(907,1010),
(927,1010),(901,1010),(914,1011),(906,1012),(904,1013);

insert into reviewer(rev_name) values
('Righty Sock'),('Jack Malvern'),('Flagrant Baronessa'),
('Alec Shaw'),(null),('Victor Woeltjen'),('Simon Wright'),
('Neal Wruck'),('Paul Monks'),('Mike Salvati'),(null),
('Wesley S. Walker'),('Sasha Goldshtein'),('Josh Cates'),('Krug Stillo'),
...
(901,9001,8.4,263575),
(902,9002,7.9,20207),(903,9003,8.3,202778),(906,9005,8.2,484746),
(924,9006,7.3,null),(908,9007,8.6,779489),(909,9008,null,227235),
(910,9009,3,195961),(911,9010,8.1,203875),(912,9011,8.4,null),
(914,9013,7,862618),(915,9001,7.7,830095),(916,9014,4,642132),
(925,9015,7.7,81328),(918,9016,null,580301),(920,9017,8.1,609451),
